...
srun -n 1 python ../../../../run_write_weights.py '../../../data/simulation/simulation_config.json' '../../../data/getPositions/positions' 'coeffs.h5' $NEURONS_PER_FILE $FILES_PER_FOLDER 'electrodes.csv' '/gpfs/bbp.cscs.ch/project/proj83/tharayil/generationCode/create_lfp_weights_for_neurodamus/examples/compare-to-reference-solutions/distant-electrodes/electrodeFile/Infinite_VeryFar_HighRes.h5 /gpfs/bbp.cscs.ch/project/proj83/tharayil/generationCode/create_lfp_weights_for_neurodamus/examples/compare-to-reference-solutions/distant-electrodes/electrodeFile/Infinite_VeryFar_HighRes.h5'
