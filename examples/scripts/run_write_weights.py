...
if __name__=='__main__':
    ...
    sigma, path_to_fields, radius = process_writeH5_inputs(sys.argv)
    
    writeH5File(path_to_simconfig,segment_position_folder,outputfile,neurons_per_file,numFilesPerFolder,sigma,path_to_fields,radius)
