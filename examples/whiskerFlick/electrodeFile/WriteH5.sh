...
srun -n 12000 python ../../scripts/run_write_weights.py $PATH_TO_SIMCONFIG $PATH_TO_POSITIONS_FOLDER $OUTPUT_FILE $NEURONS_PER_FILE $FILES_PER_FOLDER $ELECTRODE_CSV $TISSUE_CONDUCTANCE 'EEG.h5'
