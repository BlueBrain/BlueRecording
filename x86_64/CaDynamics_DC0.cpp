...
#define surftovol _ml->template fpfield<3>(_iml)
...
#define diam	*_ppvar[5].get<double*>()
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _CaDynamics_DC0_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"surftovol"} /* 3 */,
  ...
  hoc_register_prop_size(_mechtype, 8, 7);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "diam");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 CaDynamics_DC0 CaDynamics_DC0.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "CaDynamics_DC0.mod";
