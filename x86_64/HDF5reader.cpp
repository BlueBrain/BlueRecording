...
#define _tsav _ml->template fpfield<0>(_iml)
#define _tsav_columnindex 0
...
static Datum *_ppvar;
 ...
 static double _hoc_closeFile(void*);
 static double _hoc_checkVersion(void*);
 static double _hoc_exchangeSynapseLocations(void*);
 static double _hoc_getAttributeValue(void*);
 static double _hoc_getColumnData(void*);
 static double _hoc_getColumnDataRange(void*);
 static double _hoc_getDataString(void*);
 static double _hoc_getDimensions(void*);
 static double _hoc_getDataInt(void*);
 static double _hoc_getData(void*);
 static double _hoc_getNoOfColumns(void*);
 static double _hoc_loadData(void*);
 static double _hoc_numberofrows(void*);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 0 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 HDF5Reader HDF5reader.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "HDF5reader.mod";
