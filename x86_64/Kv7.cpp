...
#define t _nt->_t
#define dt _nt->_dt
#define gKv7bar _ml->template fpfield<0>(_iml)
#define gKv7bar_columnindex 0
#define ik _ml->template fpfield<1>(_iml)
#define ik_columnindex 1
#define gKv7 _ml->template fpfield<2>(_iml)
#define gKv7_columnindex 2
...
#define ntau _ml->template fpfield<6>(_iml)
#define ntau_columnindex 6
#define nalpha _ml->template fpfield<7>(_iml)
#define nalpha_columnindex 7
#define nbeta _ml->template fpfield<8>(_iml)
#define nbeta_columnindex 8
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gKv7bar"} /* 0 */,
                                       _nrn_mechanism_field<double>{"ik"} /* 1 */,
                                       _nrn_mechanism_field<double>{"gKv7"} /* 2 */,
                                       _nrn_mechanism_field<double>{"n"} /* 3 */,
                                       _nrn_mechanism_field<double>{"ek"} /* 4 */,
                                       _nrn_mechanism_field<double>{"ninf"} /* 5 */,
                                       _nrn_mechanism_field<double>{"ntau"} /* 6 */,
                                       _nrn_mechanism_field<double>{"nalpha"} /* 7 */,
                                       _nrn_mechanism_field<double>{"nbeta"} /* 8 */,
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "Kv7.mod";
