...
#define nrn_init _nrn_init__NaTg_axon
#define _nrn_initial _nrn_initial__NaTg_axon
#define nrn_cur _nrn_cur__NaTg_axon
#define _nrn_current _nrn_current__NaTg_axon
#define nrn_jacob _nrn_jacob__NaTg_axon
#define nrn_state _nrn_state__NaTg_axon
#define _net_receive _net_receive__NaTg_axon 
#define rates rates__NaTg_axon 
#define states states__NaTg_axon 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_NaTg_axon", _hoc_setdata},
 {"rates_NaTg_axon", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 {"gNaTgbar_NaTg_axon", "S/cm2"},
 {"vshifth_NaTg_axon", "mV"},
 {"vshiftm_NaTg_axon", "mV"},
 {"ina_NaTg_axon", "mA/cm2"},
 {"gNaTg_NaTg_axon", "S/cm2"},
 {0, 0}
};
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NaTg_axon NaTg_axon.mod\n");
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_NaTg_axon. Requires prior call to setdata_NaTg_axon and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "NaTg_axon.mod";
