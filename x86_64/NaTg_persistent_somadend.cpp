...
#define nrn_init _nrn_init__NaTg_persistent_somadend
#define _nrn_initial _nrn_initial__NaTg_persistent_somadend
#define nrn_cur _nrn_cur__NaTg_persistent_somadend
#define _nrn_current _nrn_current__NaTg_persistent_somadend
#define nrn_jacob _nrn_jacob__NaTg_persistent_somadend
#define nrn_state _nrn_state__NaTg_persistent_somadend
#define _net_receive _net_receive__NaTg_persistent_somadend 
#define rates rates__NaTg_persistent_somadend 
#define states states__NaTg_persistent_somadend 
...
#define t _nt->_t
#define dt _nt->_dt
#define gNaTgbar _ml->template fpfield<0>(_iml)
#define gNaTgbar_columnindex 0
#define vshiftm _ml->template fpfield<1>(_iml)
#define vshiftm_columnindex 1
#define slopem _ml->template fpfield<2>(_iml)
#define slopem_columnindex 2
#define ina _ml->template fpfield<3>(_iml)
#define ina_columnindex 3
#define gNaTg _ml->template fpfield<4>(_iml)
#define gNaTg_columnindex 4
#define m _ml->template fpfield<5>(_iml)
#define m_columnindex 5
#define ttxo _ml->template fpfield<6>(_iml)
#define ttxo_columnindex 6
#define ttxi _ml->template fpfield<7>(_iml)
#define ttxi_columnindex 7
...
#define mTau _ml->template fpfield<10>(_iml)
#define mTau_columnindex 10
#define mAlpha _ml->template fpfield<11>(_iml)
#define mAlpha_columnindex 11
#define mBeta _ml->template fpfield<12>(_iml)
#define mBeta_columnindex 12
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_NaTg_persistent_somadend", _hoc_setdata},
 {"rates_NaTg_persistent_somadend", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 {"gNaTgbar_NaTg_persistent_somadend", "S/cm2"},
 {"vshiftm_NaTg_persistent_somadend", "mV"},
 {"ina_NaTg_persistent_somadend", "mA/cm2"},
 {"gNaTg_NaTg_persistent_somadend", "S/cm2"},
 {0, 0}
};
...
#define _cvode_ieq _ppvar[5].literal_value<int>()
 ...
 "7.7.0",
"NaTg_persistent_somadend",
 "gNaTgbar_NaTg_persistent_somadend",
 "vshiftm_NaTg_persistent_somadend",
 "slopem_NaTg_persistent_somadend",
 0,
 "ina_NaTg_persistent_somadend",
 "gNaTg_NaTg_persistent_somadend",
 0,
 "m_NaTg_persistent_somadend",
 0,
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _NaTg_persistent_somadend_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("na", -10000.);
 	ion_reg("ttx", 1.0);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gNaTgbar"} /* 0 */,
                                       _nrn_mechanism_field<double>{"vshiftm"} /* 1 */,
                                       _nrn_mechanism_field<double>{"slopem"} /* 2 */,
                                       _nrn_mechanism_field<double>{"ina"} /* 3 */,
                                       _nrn_mechanism_field<double>{"gNaTg"} /* 4 */,
                                       _nrn_mechanism_field<double>{"m"} /* 5 */,
                                       _nrn_mechanism_field<double>{"ttxo"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ttxi"} /* 7 */,
                                       _nrn_mechanism_field<double>{"ena"} /* 8 */,
                                       _nrn_mechanism_field<double>{"mInf"} /* 9 */,
                                       _nrn_mechanism_field<double>{"mTau"} /* 10 */,
                                       _nrn_mechanism_field<double>{"mAlpha"} /* 11 */,
                                       _nrn_mechanism_field<double>{"mBeta"} /* 12 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NaTg_persistent_somadend NaTg_persistent_somadend.mod\n");
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_NaTg_persistent_somadend. Requires prior call to setdata_NaTg_persistent_somadend and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "NaTg_persistent_somadend.mod";
