...
#define nrn_init _nrn_init__NaTg_somadend
#define _nrn_initial _nrn_initial__NaTg_somadend
#define nrn_cur _nrn_cur__NaTg_somadend
#define _nrn_current _nrn_current__NaTg_somadend
#define nrn_jacob _nrn_jacob__NaTg_somadend
#define nrn_state _nrn_state__NaTg_somadend
#define _net_receive _net_receive__NaTg_somadend 
#define rates rates__NaTg_somadend 
#define states states__NaTg_somadend 
...
#define vshifth _ml->template fpfield<1>(_iml)
#define vshifth_columnindex 1
#define vshiftm _ml->template fpfield<2>(_iml)
#define vshiftm_columnindex 2
#define slopeh _ml->template fpfield<3>(_iml)
#define slopeh_columnindex 3
#define slopem _ml->template fpfield<4>(_iml)
#define slopem_columnindex 4
#define ina _ml->template fpfield<5>(_iml)
#define ina_columnindex 5
#define gNaTg _ml->template fpfield<6>(_iml)
...
#define ttxo _ml->template fpfield<9>(_iml)
#define ttxo_columnindex 9
#define ttxi _ml->template fpfield<10>(_iml)
...
#define mAlpha _ml->template fpfield<14>(_iml)
#define mAlpha_columnindex 14
#define mBeta _ml->template fpfield<15>(_iml)
#define mBeta_columnindex 15
#define hInf _ml->template fpfield<16>(_iml)
#define hInf_columnindex 16
#define hTau _ml->template fpfield<17>(_iml)
#define hTau_columnindex 17
#define hAlpha _ml->template fpfield<18>(_iml)
#define hAlpha_columnindex 18
#define hBeta _ml->template fpfield<19>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_NaTg_somadend", _hoc_setdata},
 {"rates_NaTg_somadend", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 {"gNaTgbar_NaTg_somadend", "S/cm2"},
 {"vshifth_NaTg_somadend", "mV"},
 {"vshiftm_NaTg_somadend", "mV"},
 {"ina_NaTg_somadend", "mA/cm2"},
 {"gNaTg_NaTg_somadend", "S/cm2"},
 {0, 0}
};
...
#define _cvode_ieq _ppvar[5].literal_value<int>()
 ...
 "7.7.0",
"NaTg_somadend",
 "gNaTgbar_NaTg_somadend",
 "vshifth_NaTg_somadend",
 "vshiftm_NaTg_somadend",
 "slopeh_NaTg_somadend",
 "slopem_NaTg_somadend",
 0,
 "ina_NaTg_somadend",
 "gNaTg_NaTg_somadend",
 0,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _NaTg_somadend_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("na", -10000.);
 	ion_reg("ttx", 1.0);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"vshifth"} /* 1 */,
                                       _nrn_mechanism_field<double>{"vshiftm"} /* 2 */,
                                       _nrn_mechanism_field<double>{"slopeh"} /* 3 */,
                                       _nrn_mechanism_field<double>{"slopem"} /* 4 */,
                                       _nrn_mechanism_field<double>{"ina"} /* 5 */,
                                       _nrn_mechanism_field<double>{"gNaTg"} /* 6 */,
                                       _nrn_mechanism_field<double>{"m"} /* 7 */,
                                       _nrn_mechanism_field<double>{"h"} /* 8 */,
                                       _nrn_mechanism_field<double>{"ttxo"} /* 9 */,
                                       _nrn_mechanism_field<double>{"ttxi"} /* 10 */,
                                       _nrn_mechanism_field<double>{"ena"} /* 11 */,
                                       _nrn_mechanism_field<double>{"mInf"} /* 12 */,
                                       _nrn_mechanism_field<double>{"mTau"} /* 13 */,
                                       _nrn_mechanism_field<double>{"mAlpha"} /* 14 */,
                                       _nrn_mechanism_field<double>{"mBeta"} /* 15 */,
                                       _nrn_mechanism_field<double>{"hInf"} /* 16 */,
                                       _nrn_mechanism_field<double>{"hTau"} /* 17 */,
                                       _nrn_mechanism_field<double>{"hAlpha"} /* 18 */,
                                       _nrn_mechanism_field<double>{"hBeta"} /* 19 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NaTg_somadend NaTg_somadend.mod\n");
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_NaTg_somadend. Requires prior call to setdata_NaTg_somadend and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "NaTg_somadend.mod";
