...
#define clearRNG clearRNG__ProbAMPANMDA_EMS 
...
#define Use _ml->template fpfield<1>(_iml)
#define Use_columnindex 1
#define Dep _ml->template fpfield<2>(_iml)
#define Dep_columnindex 2
#define Fac _ml->template fpfield<3>(_iml)
#define Fac_columnindex 3
#define mg _ml->template fpfield<4>(_iml)
#define mg_columnindex 4
#define u0 _ml->template fpfield<5>(_iml)
#define u0_columnindex 5
#define Nrrp _ml->template fpfield<6>(_iml)
#define Nrrp_columnindex 6
#define synapseID _ml->template fpfield<7>(_iml)
#define synapseID_columnindex 7
#define verboseLevel _ml->template fpfield<8>(_iml)
#define verboseLevel_columnindex 8
#define selected_for_report _ml->template fpfield<9>(_iml)
#define selected_for_report_columnindex 9
#define NMDA_ratio _ml->template fpfield<10>(_iml)
#define NMDA_ratio_columnindex 10
#define conductance _ml->template fpfield<11>(_iml)
...
#define g _ml->template fpfield<17>(_iml)
#define g_columnindex 17
#define A_AMPA_step _ml->template fpfield<18>(_iml)
#define A_AMPA_step_columnindex 18
#define B_AMPA_step _ml->template fpfield<19>(_iml)
#define B_AMPA_step_columnindex 19
#define A_NMDA_step _ml->template fpfield<20>(_iml)
#define A_NMDA_step_columnindex 20
#define B_NMDA_step _ml->template fpfield<21>(_iml)
#define B_NMDA_step_columnindex 21
#define unoccupied _ml->template fpfield<22>(_iml)
#define unoccupied_columnindex 22
#define occupied _ml->template fpfield<23>(_iml)
#define occupied_columnindex 23
#define tsyn _ml->template fpfield<24>(_iml)
#define tsyn_columnindex 24
#define u _ml->template fpfield<25>(_iml)
#define u_columnindex 25
#define next_delay _ml->template fpfield<26>(_iml)
#define next_delay_columnindex 26
#define A_AMPA _ml->template fpfield<27>(_iml)
#define A_AMPA_columnindex 27
#define B_AMPA _ml->template fpfield<28>(_iml)
#define B_AMPA_columnindex 28
#define A_NMDA _ml->template fpfield<29>(_iml)
#define A_NMDA_columnindex 29
#define B_NMDA _ml->template fpfield<30>(_iml)
#define B_NMDA_columnindex 30
#define factor_AMPA _ml->template fpfield<31>(_iml)
#define factor_AMPA_columnindex 31
#define factor_NMDA _ml->template fpfield<32>(_iml)
#define factor_NMDA_columnindex 32
#define mggate _ml->template fpfield<33>(_iml)
#define mggate_columnindex 33
#define usingR123 _ml->template fpfield<34>(_iml)
#define usingR123_columnindex 34
#define DA_AMPA _ml->template fpfield<35>(_iml)
#define DA_AMPA_columnindex 35
#define DB_AMPA _ml->template fpfield<36>(_iml)
#define DB_AMPA_columnindex 36
#define DA_NMDA _ml->template fpfield<37>(_iml)
#define DA_NMDA_columnindex 37
#define DB_NMDA _ml->template fpfield<38>(_iml)
#define DB_NMDA_columnindex 38
#define v _ml->template fpfield<39>(_iml)
#define v_columnindex 39
#define _g _ml->template fpfield<40>(_iml)
#define _g_columnindex 40
#define _tsav _ml->template fpfield<41>(_iml)
#define _tsav_columnindex 41
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ProbAMPANMDA_EMS_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Use"} /* 1 */,
                                       _nrn_mechanism_field<double>{"Dep"} /* 2 */,
                                       _nrn_mechanism_field<double>{"Fac"} /* 3 */,
                                       _nrn_mechanism_field<double>{"mg"} /* 4 */,
                                       _nrn_mechanism_field<double>{"u0"} /* 5 */,
                                       _nrn_mechanism_field<double>{"Nrrp"} /* 6 */,
                                       _nrn_mechanism_field<double>{"synapseID"} /* 7 */,
                                       _nrn_mechanism_field<double>{"verboseLevel"} /* 8 */,
                                       _nrn_mechanism_field<double>{"selected_for_report"} /* 9 */,
                                       _nrn_mechanism_field<double>{"NMDA_ratio"} /* 10 */,
                                       _nrn_mechanism_field<double>{"conductance"} /* 11 */,
                                       ...
                                       _nrn_mechanism_field<double>{"g"} /* 17 */,
                                       _nrn_mechanism_field<double>{"A_AMPA_step"} /* 18 */,
                                       _nrn_mechanism_field<double>{"B_AMPA_step"} /* 19 */,
                                       _nrn_mechanism_field<double>{"A_NMDA_step"} /* 20 */,
                                       _nrn_mechanism_field<double>{"B_NMDA_step"} /* 21 */,
                                       _nrn_mechanism_field<double>{"unoccupied"} /* 22 */,
                                       _nrn_mechanism_field<double>{"occupied"} /* 23 */,
                                       _nrn_mechanism_field<double>{"tsyn"} /* 24 */,
                                       _nrn_mechanism_field<double>{"u"} /* 25 */,
                                       _nrn_mechanism_field<double>{"next_delay"} /* 26 */,
                                       _nrn_mechanism_field<double>{"A_AMPA"} /* 27 */,
                                       _nrn_mechanism_field<double>{"B_AMPA"} /* 28 */,
                                       _nrn_mechanism_field<double>{"A_NMDA"} /* 29 */,
                                       _nrn_mechanism_field<double>{"B_NMDA"} /* 30 */,
                                       _nrn_mechanism_field<double>{"factor_AMPA"} /* 31 */,
                                       _nrn_mechanism_field<double>{"factor_NMDA"} /* 32 */,
                                       _nrn_mechanism_field<double>{"mggate"} /* 33 */,
                                       _nrn_mechanism_field<double>{"usingR123"} /* 34 */,
                                       _nrn_mechanism_field<double>{"DA_AMPA"} /* 35 */,
                                       _nrn_mechanism_field<double>{"DB_AMPA"} /* 36 */,
                                       _nrn_mechanism_field<double>{"DA_NMDA"} /* 37 */,
                                       _nrn_mechanism_field<double>{"DB_NMDA"} /* 38 */,
                                       _nrn_mechanism_field<double>{"v"} /* 39 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 40 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 41 */,
...
static int _reset;
static const char *modelname = "Probabilistic AMPA and NMDA receptor with presynaptic short-term plasticity";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "ProbAMPANMDA_EMS.mod";
